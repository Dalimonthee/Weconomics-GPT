...
class LightRAG:
    ...
    # Integration and Addon parameters
    # ---

    DISABLE_ENTITY_EXTRACTION: bool = field(default=bool(os.getenv("DISABLE_ENTITY_EXTRACTION", False)))
    """If True, completely disables entity extraction to avoid hallucination issues and reduce API costs."""
    ...
    async def _process_entity_relation_graph(
        ...
        if hasattr(self, 'DISABLE_ENTITY_EXTRACTION') and self.DISABLE_ENTITY_EXTRACTION:
            logger.info("Entity extraction is disabled, skipping")
            if pipeline_status is not None and pipeline_status_lock is not None:
                async with pipeline_status_lock:
                    message = "Entity extraction disabled by configuration"
